...
public class SlimefunItem implements Placeable {
    ...
    public final void addWikiPage(@Nonnull String page) {
        ...
        if (addon == null) {
            // FIX: Corrected string concatenation and error message
            Slimefun.logger().warning("Could not add wiki page for \"" + getId() + "\": The item has not been registered yet (its addon is null).");
            return;
        }
