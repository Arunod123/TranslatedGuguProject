...
class VersionsCommand extends SubCommand {
     ...
     */
    private static final String JAVA_VERSION_NOTICE = "Java 16+ at Minecraft 1.17 release!";
    ...
    public void onExecute(@Nonnull CommandSender sender, @Nonnull String[] args) {
        if (sender.hasPermission("slimefun.command.versions") || sender instanceof ConsoleCommandSender) {
            ...
            builder.append(Component.text("Slimefun Runs the server environment:\n", Style.style(NamedTextColor.GRAY)))
            ...
            builder.append(Component.text("By StarWishsama", Style.style(NamedTextColor.WHITE)))
                    .append(Component.text(
                            "Please don't screen this version of the message to Discord/Github feedback Bug\n prioritizes to the Hanan page feedback", Style.style(NamedTextColor.RED)));

            if (Slimefun.getConfigManager().isBypassEnvironmentCheck()) {
                builder.append(Component.text("Disabled environmental compatibility check", Style.style(NamedTextColor.RED)));
            }

            if (Slimefun.getConfigManager().isBypassItemLengthCheck()) {
                builder.append(Component.text("\n \n long check of disabled items", Style.style(NamedTextColor.RED)));
            }
    ...
    private void addJavaVersion(@Nonnull net.kyori.adventure.text.TextComponent.Builder builder) {
        ...
        if (version < RECOMMENDED_JAVA_VERSION) {
            Component hover = Component.text("The Java version you used is outdated!"
                    + "I recommend you use Java."
    ...
    private void addPluginVersions(@Nonnull net.kyori.adventure.text.TextComponent.Builder builder) {
        ...
        if (addons.isEmpty()) {
            builder.append(Component.text("No access plugin installed", NamedTextColor.GRAY).decorate(TextDecoration.ITALIC));
            return;
        }

        builder.append(Component.text("Auxiliary plugins installed:", NamedTextColor.GRAY))
            ...
            if (Bukkit.getPluginManager().isPluginEnabled(plugin)) {
                ...
                if (plugin instanceof SlimefunAddon addon && addon.getBugTrackerURL() != null) {
                    ...
                    try {
                        ...
                        Component hoverComp = Component.text()
                                ...
                                .append(Component.text("Click to open the feedback page", NamedTextColor.GOLD))
                                .build();
                        ...
                        Component hoverComp = Component.text()
                                .append(Component.text("Author:", NamedTextColor.YELLOW))
                                .append(Component.text(authors, NamedTextColor.YELLOW))
                                .append(Component.text("The attached feedback link is not valid!", NamedTextColor.RED))
                                .build();
                ...
                if (plugin instanceof SlimefunAddon addon && addon.getBugTrackerURL() != null) {
                    try {
                        ...
                        Component hoverComp = Component.text()
                                .append(Component.text("This plugin has been disabled. Please check the backstage.", NamedTextColor.RED))
                                .append(Component.text("Click to open the feedback page", NamedTextColor.DARK_RED))
                                .build();
                        ...
                        Component hoverComp = Component.text()
                                .append(Component.text("This plugin has been disabled. Please check the backstage.", NamedTextColor.RED))
                                .append(Component.text("The feedback link provided by the \n> plugin is invalid", NamedTextColor.DARK_RED))
                                .build();

                        hoverEvent = HoverEvent.showText(hoverComp);
                    }
                } else {
                    Component hoverComp = Component.text("Plugins are disabled, please check the backstage for error.");
                    hoverEvent = HoverEvent.showText(hoverComp);
                }
            }
