...
public enum Radioactivity {
     ...
     */
    MODERATE(ChatColor.YELLOW, "Medium", 2),
     ...
     */
    VERY_HIGH(ChatColor.RED, "It's very high.", 5),
     ...
     */
    VERY_DEADLY(ChatColor.DARK_RED, "Death.", 10);
    ...
    public @Nonnull String getLore() {
        return ChatColor.GREEN + "\u2622" + ChatColor.GRAY + "Level of radiation:" + color + displayName;
    }
