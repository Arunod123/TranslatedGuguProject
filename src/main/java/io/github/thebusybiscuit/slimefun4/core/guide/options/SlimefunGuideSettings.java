    ...
    private static void addHeader(Player p, ChestMenu menu, ItemStack guide) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "By StarWishsama",
                        "& c Please do not screen this version of information to Discord/Github feedback Bug",
                        "&c prioritizes feedback on the Hanan page",
                        "",
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "& 7 Recent activities in: & a" + NumberUtils.getElapsedTime(github.getLastUpdate()) + "Front",
                        "&7Forks: &e" + github.getForks(),
                        "&7Stars: &e" + github.getStars(),
                        "",
                        "& 7 & oSlimefun 4 is a community-based project.",
                        "& 7&o source code can be found on GitHub",
                        "♪ 7 ♪ If you want this project to continue ♪",
                        "You can consider contributing to the project.",
                        "",
                        "& rou21E8 & e click to the Han version of the GitHub repository"));
        // @formatter:on
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "& 7 Do you need help with objects or machines?",
                        "♪ 7 You don't know what to do?",
                        "& 7 view our community-maintained wiki",
                        "& 7 consider becoming an editor!",
                        "",
                        "& vu21E8 & e click to unofficial Chinese Wiki"));
        // @formatter:on
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "& 7Slimefun is a large project but an accessory plugin exists",
                        "& 7 makes Slimefun really glow",
                        "Look at them. Maybe the accessory plugin you're looking for is right there!",
                        "",
                        "Auxiliary plugins & 7 have been installed: & b" + Slimefun.getInstalledAddons().size(),
                        "",
                        "& bou21E8 & e Click for access to Slimefun4 satellite plugins"));
        // @formatter:on
