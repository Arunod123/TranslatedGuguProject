    ...
    public Optional<ItemStack> getDisplayItem(Player p, ItemStack guide) {
        ...
        if (cfgManager.isResearchingEnabled() && cfgManager.isResearchFireworkEnabled()) {
            ...
            ItemStack item = new CustomItemStack(
                    ...
                    "& b Fireworks Effects: &" + (enabled ? "a Enabled" : "4 Disable"),
                    "",
                    "♪ 7 You can choose now ♪",
                    "& 7 unlocking a new item",
                    "& 7 shows the fireworks effects.",
                    "",
                    "& vu21E8 & e" + (enabled ? "Disable" : "Enable") + "Fireworks");
