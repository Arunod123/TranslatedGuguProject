...
public class WitherAssembler extends AbstractEntityAssembler<Wither> {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        preset.addItem(
                1,
                new CustomItemStack(getHead(), "♪ Seven broken skulls ♪", "", "& f put a broken skull here."),
                ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(
                7, new CustomItemStack(getBody(), "& 7 Soul Sands", "", "♪ f Put the sand in here ♪"), ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(
                13,
