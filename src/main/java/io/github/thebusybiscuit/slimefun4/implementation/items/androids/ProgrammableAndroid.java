...
public class ProgrammableAndroid extends SlimefunItem
    ...
    public ProgrammableAndroid(
        ...
        new UniversalMenuPreset(getId(), "Programmable Robots") {
            ...
            public void newInstance(UniversalMenu menu, Block b) {
                ...
                menu.replaceExistingItem(
                        15, new CustomItemStack(HeadTexture.SCRIPT_START.getAsItemStack(), "&a Start/Continue"));
                ...
                menu.replaceExistingItem(17, new CustomItemStack(HeadTexture.SCRIPT_PAUSE.getAsItemStack(), "& 4 Suspended"));
                ...
                menu.replaceExistingItem(
                        16,
                        new CustomItemStack(
                                HeadTexture.ENERGY_REGULATOR.getAsItemStack(), "& b Memory Core", "", "& 8\u21E8 & 7 Click to open script editor"));
    ...
    public void openScript(Player p, SlimefunUniversalBlockData uniData, String sourceCode) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "& vu21E8 & e left key & 7 returns to the robot's control panel"));
            ...
            if (i == script.length - 1) {
                ...
                menu.addItem(
                        ...
                        new CustomItemStack(
                                ...
                                "",
                                "& rou21E8 & e & 7, ed.",
                                "& vu21E8 & e Right Key & 7 Delete",
                                "& bou21E8 & eShift+Right Key & 7 Copy"));
                menu.addMenuClickHandler(i, (pl, slot, item, action) -> {
    ...
    protected void openScriptDownloader(Player p, SlimefunUniversalBlockData uniData, int page) {
        ChestMenu menu = new ChestMenu("Robot Script");
        ...
        menu.addItem(
                48,
                new CustomItemStack(
                        HeadTexture.SCRIPT_UP.getAsItemStack(), "& e Upload Script", "", "& 6 click & 7 on the script you're using", "& 7 Upload to Server"));
        ...
        menu.addItem(53, new CustomItemStack(HeadTexture.SCRIPT_LEFT.getAsItemStack(), "& 6> returns", "", "& 7 returns robotic control panel"));
    ...
    public void openScriptEditor(Player p, SlimefunUniversalBlockData uniData) {
        ...
        menu.addItem(1, new CustomItemStack(HeadTexture.SCRIPT_FORWARD.getAsItemStack(), "Edit Script", "", "& a Modify your existing script"));
        ...
        menu.addItem(
                3,
                new CustomItemStack(
                        HeadTexture.SCRIPT_NEW.getAsItemStack(), "& 4> Create New Script", "", "& c Delete scripts you're using", "& c and create a completely new blank script"));
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "& 6> Download Script",
                        "",
                        "& e Download scripts uploaded by other players from the server",
                        "& e can be used immediately, or modified before using"));
        menu.addMenuClickHandler(5, (pl, slot, item, action) -> {
            openScriptDownloader(pl, uniData, 1);
            return false;
        });

        menu.addItem(8, new CustomItemStack(HeadTexture.SCRIPT_LEFT.getAsItemStack(), "& 6> returns", "", "& 7 returns robotic control panel"));
    ...
    protected void editInstruction(Player p, SlimefunUniversalBlockData uniData, String[] script, int index) {
        ...
        menu.addItem(
                9,
                new CustomItemStack(HeadTexture.SCRIPT_PAUSE.getAsItemStack(), "& f Don't do anything."),
                (pl, slot, item, action) -> {
                    String code = deleteInstruction(script, index);
                    setScript(uniData, code);
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (MachineFuel fuel : fuelTypes) {
            ...
            lore.add(ChatColors.color("& 8\u21E8 & 7 Surplus" + NumberUtils.getTimeLeft(fuel.getTicks() / 2)));
            im.setLore(lore);
            item.setItemMeta(im);
            list.add(item);
        }
