...
public class TickerTask implements Runnable {
    ...
    private void reportErrors(Location l, SlimefunItem item, Throwable x) {
        ...
        if (errors == 1) {
            ...
            Slimefun.logger().log(Level.SEVERE, "There have been multiple errors in the last four Ticks, and the machine corresponding to the cube has been disabled.");
            Slimefun.logger().log(Level.SEVERE, "See error details in /plugins/Slimefun/error-reports/ folders.");
            Slimefun.logger().log(Level.SEVERE, "If the feedback is wrong, send the error report file instead of sending a screenshot of this window");
