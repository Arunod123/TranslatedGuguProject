...
abstract class AbstractFilterNode extends AbstractCargoNode {
    ...
    protected void createBorder(BlockMenuPreset preset) {
        ...
        preset.addItem(
                2,
                new CustomItemStack(Material.PAPER, "& 3 Items", "", "& b adds you to the black and white list.", "& b's items here"),
                ChestMenuUtils.getEmptyClickHandler());
    }
    ...
    protected void updateBlockMenu(BlockMenu menu, Block b) {
        ...
        if (filterType == null || filterType.equals("whitelist")) {
            menu.replaceExistingItem(15, new CustomItemStack(Material.WHITE_WOOL, "& 7 Mode: & r White List", "", "& e> Click to switch to blacklist"));
            ...
            menu.replaceExistingItem(15, new CustomItemStack(Material.BLACK_WOOL, "& 7 Mode: & 8 blacklist", "", "& e> Click to switch to White List"));
            menu.addMenuClickHandler(15, (p, slot, item, action) -> {
        ...
        if (lore == null || lore.equals(String.valueOf(true))) {
            menu.replaceExistingItem(
                    25, new CustomItemStack(Material.MAP, "& 7 matches text under article name: & 2\u2714", "", "& e> Click Enable Matching Text"));
            ...
            menu.replaceExistingItem(
                    25, new CustomItemStack(Material.MAP, "& 7 matches text under article name: & 4\u2718", "", "& e> Click off matching text"));
            menu.addMenuClickHandler(25, (p, slot, item, action) -> {
