...
public final class PostSetup {
    ...
    public static void setupWiki() {
        Slimefun.logger().log(Level.INFO, "Load Wiki Pages...");
    ...
    public static void loadItems() {
        ...
        sender.sendMessage(ChatColor.GREEN + "- Bug Feedback: https://github.com/SlimefunGuguProject/Slimefun4/issues");
