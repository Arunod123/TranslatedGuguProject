        ...
        if (roundRobinMode == null || roundRobinMode.equals(String.valueOf(false))) {
            menu.replaceExistingItem(
                    ...
                    new CustomItemStack(
                            ...
                            "& 7 rotation mode: & 4\u2718",
                            "",
                            "& e> Click to enable rotation mode",
                            "& e (items will be distributed evenly in the channel)"));
        ...
        if (smartFillNode == null || smartFillNode.equals(String.valueOf(false))) {
            menu.replaceExistingItem(
                    ...
                    new CustomItemStack(
                            ...
                            "& e> Click Enable",
                            "",
                            "When & f is open, the shipping node will try",
                            "& f Keep items in the cargo network at a certain level",
                            "But it's not perfect.",
                            "& f will still try to fill the empty space in front of a pile of things."));
