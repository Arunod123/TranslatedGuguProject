...
public final class VersionedBiome {
    ...
    public static Biome valueOf(@Nonnull String biomeName) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException("Could not close temporary folder: %s" + biomeName, e);
        }
        throw new IllegalArgumentException("Biome. Valueof method not available");
    }
}
