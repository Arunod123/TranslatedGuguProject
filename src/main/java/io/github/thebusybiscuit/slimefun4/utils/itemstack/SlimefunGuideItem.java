...
public class SlimefunGuideItem extends ItemStack {
    ...
    public SlimefunGuideItem(@Nonnull SlimefunGuideImplementation implementation, @Nonnull String name) {
        ...
        lore.add(type == SlimefunGuideMode.CHEAT_MODE ? ChatColors.color("& 4&l for administrators only") : "");
        lore.add(ChatColors.color("& e Right Key & 8\u21E8 & 7 Browse Articles"));
        lore.add(ChatColors.color("& eShift+Right Key & 8\u21E8 & 7 Open Settings / About"));
