...
public final class LoreBuilder {
    ...
    public static final String HAZMAT_SUIT_REQUIRED = "& 8\u21E8 & 4 need chemical suits!";
    public static final String RAINBOW = "& d turn the colour of rainbows!";
    public static final String RIGHT_CLICK_TO_USE = "& e Right & 7 Use";
    public static final String RIGHT_CLICK_TO_OPEN = "& e Right & 7 Open";
    public static final String CROUCH_TO_USE = "& e Hold & e Down & 7 Use";
    ...
    public static @Nonnull String speed(float speed) {
        return "& 8\u21E8 & b\u26A1 & 7: & b" + speed + 'x';
    }

    public static @Nonnull String powerBuffer(int power) {
        return power(power, "Storageable");
    }
    ...
    public static @Nonnull String material(String material) {
        return "& 8\u21E8 & 7 Materials: & b" + material;
    }

    public static @Nonnull String hunger(double value) {
        return "& 7 & o Restore & b & o" + hungerFormat.format(value) + "& 7 & O Point Hunger";
    }

    public static @Nonnull String range(int blocks) {
        return "& 7 Scope: & c" + blocks + "Glut.";
    }

    public static @Nonnull String usesLeft(int usesLeft) {
        return "& 7 can also use & e" + usesLeft + "Number of times";
    }
}
